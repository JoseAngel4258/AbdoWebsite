...
const FAQSection = () => {
  ...
  return (
    <section
      id="question"
      className="relative h-[100vh] flex flex-col justify-center items-center snap-center pt-16 text-white"
    >
      <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
        ...
        <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700">
          <details>
            <summary className="py-2 outline-none cursor-pointer focus:text-gray-200">
